...
export default class ProfileConcept {
  ...
  async create(_id: ObjectId, username: string, bio: string, image: string, hasPaywall: boolean = false) {
    // TODO: use the _id generated by the account entry
    await this.profiles.createOne({ _id, username, bio, image, hasPaywall }, false);
